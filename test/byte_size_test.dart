...
void main() {
  ...
  String formatOutputLocale(double digits, int precision, String symbol, Locale locale_LANG) {
    var format = NumberFormat.decimalPattern('${locale_LANG}');
    // Added 1 to precision because of locale format function behaviour
    final output = format.format(double.parse(digits.toStringAsPrecision(precision + 1))) + ' $symbol';
  ...
  group('CreatingMethodsTest', () {
    ...
    test('cConstructor', () {
      ...
      // Act
      final result = ByteSize(byteSize: byteSize.toDouble());
  ...
  group('ParsingMethodsTest', () {
    ...
    test('ParsePartialBits', () {
      ...
      expect(() => ByteSize.Parse(val), throwsA(predicate((e) => e is FormatException)));
    });

    test('ParseThrowsOnInvalid', () {
      final badValue = 'Unexpected Value';

      expect(() => ByteSize.Parse(badValue), throwsA(predicate((e) => e is FormatException)));
    });
  ...
  group('ToStringMethodTest', () {
    ...
    test('ReturnsDefaultNumberFormat', () {
      ...
      // Act
      final result = b.ToString(symbol: 'KB');
      final expected = formatOutputLocale(lDouble, 2, 'KB', Locale.en_US);
    ...
    test('ReturnsProvidedNumberFormat', () {
      ...
      // Act
      final result = b.ToString(symbol: 'KB', precision: 4);
    ...
    test('ReturnsBits', () {
      ...
      // Act
      final result = b.ToString(symbol: 'b');
    ...
    test('ReturnsMegaBytes', () {
      ...
      // Act
      final result = b.ToString(symbol: 'MB');
    ...
    test('ReturnsGigaBytes', () {
      ...
      // Act
      final result = b.ToString(symbol: 'GB');
    ...
    test('ReturnsTeraBytes', () {
      ...
      // Act
      final result = b.ToString(symbol: 'TB');
    ...
    test('ReturnsPetaBytes', () {
      ...
      // Act
      final result = b.ToString(symbol: 'PB');
    ...
    test('ReturnsLargestMetricSuffixUsingCustomFormatSettingsOne', () {
      ...
      // Act
      final result = b.ToString(symbol: 'MB', precision: 2, locale_LANG: Locale.fr_CA);
    ...
    test('ReturnsLargestMetricSuffixUsingCustomFormatSettingsTwo', () {
      ...
      // Act
      final result = b.ToString(symbol: 'MB', precision: 1, locale_LANG: Locale.de_DE);
    ...
    test('ReturnsLargestMetricSuffixUsingCustomFormatSettingsThree', () {
      ...
      // Act
      final result = b.ToString(symbol: 'KB', precision: 1, locale_LANG: Locale.de_DE);
